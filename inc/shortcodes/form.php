...
function fn_mgjo_applicant_form() {
	...
	<form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" class="mgjoform">
        ...
        <div class="mgjoform__row">
            ...
            ?>
            <input id="chklegal" name="chklegal" type="checkbox"><label for="chklegal" class="mgjoform__legal"><?php printf( __('Aceptación de las <a href="%s" target="_blank">Condiciones Legales</a>.', 'mg-wp-job-offers'), pll_get_page_url('aviso-legal-y-condiciones-generales-de-uso') ); ?></label>
        </div>
